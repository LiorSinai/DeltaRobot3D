...
for timeStep = 1:Nvalid
   ...
   errorMomentsResidue(1:3,timeStep)=I_C(1:3).*alphaC+...
                                ...
                                -tilde([0; 0 ;+L_u/2])*R'*forcesA1+...
                                -tilde([0; 0 ;-L_u/2])*R'*forcesB1+...
                                -momentsC;
   % components of the error
   M1(:,timeStep)=I_C(1:3).*alphaC;
   M2(:,timeStep)=tilde(omegaC)*diag(I_C(1:3))*omegaC;
   M3(:,timeStep)=tilde([0; 0 ;+L_u/2])*R'*forcesA1;
   M4(:,timeStep)=tilde([0; 0 ;-L_u/2])*R'*forcesB1;
   ...
   errorMomentsResidue(4:6,timeStep)=I_C(1:3).*alphaC+...
                                +tilde(omegaC)*diag(I_C(1:3))*omegaC+...
                                -tilde([0; 0 ;+L_u/2])*R'*forcesA2+...
                                -tilde([0; 0 ;-L_u/2])*R'*forcesB2+...
                                -momentsC;
   ...
   errorMomentsResidue(7:9,timeStep)=I_C(1:3).*alphaC+...
                                +tilde(omegaC)*diag(I_C(1:3))*omegaC+...
                                -tilde([0; 0 ;+L_u/2])*R'*forcesA3+...
                                -tilde([0; 0 ;-L_u/2])*R'*forcesB3+...
                                -momentsC;
