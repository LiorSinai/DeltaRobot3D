...
Q_sim(ind_i,:)= Qi_CTC.Data';
Q_sim(ind_d,:)= Qd_CTC.Data';
t_sim = Qi_CTC.Time;
thetaA_sim = thetaA_CTC.Data';

R_L1_sim=zeros(3,3,N);
R_L2_sim=R_L1_sim;
R_L3_sim=R_L1_sim;
for timeStep=1:N
    R_L1_sim(:,:,timeStep)=R_L1_CTC.Data(:,:,timeStep);
    R_L2_sim(:,:,timeStep)=R_L2_CTC.Data(:,:,timeStep);
    R_L3_sim(:,:,timeStep)=R_L3_CTC.Data(:,:,timeStep);
end
