...
colors={'k','b','r'};
for k=1:3
    plot(time_range,wrenches(5).moments(k,:),'-','Color',colors{k})
end
hold on
for k=1:3
    plot(time_range,wrenches(5).momentsC(k,:),'x','Color',colors{k})
end
...
hold on
for k=1:3
    plot(time_range,wrenches(1).momentsC(k,:),specs{k},'Color',colors{1})
end
for k=1:3
    plot(time_range,wrenches(3).momentsC(k,:),specs{k},'Color',colors{3})
end
for k=1:3
    plot(time_range,wrenches(5).momentsC(k,:),specs{k},'Color',colors{2})
end
